<aside id="main-sidebar">
    <nav class="sidebar-nav">
        <ul>
            ...
            <li style="display: none"><a href="#"><img src="<?= base_url('assets/imgs/old-world-logo-48x48.webp') ?>" alt="Microsoft Office World icon" class="logo" /> <span class="tool-name"><?= lang('Sidebar.Office') ?></span></a></li>
            <li style="display: none"><a href="#"><img src="<?= base_url('assets/imgs/roblox-logo-48x48.webp') ?>" alt="Roblox icon" class="logo" /> <span class="tool-name"><?= lang('Sidebar.Roblox') ?></span></a></li>
        </ul>
    </nav>
